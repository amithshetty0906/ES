...
HD_PWD='D:/aca2301390021/xnor/xnor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xnorg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xnorg.tcl -notrace
