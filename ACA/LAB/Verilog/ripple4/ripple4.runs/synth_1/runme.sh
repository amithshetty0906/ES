...
HD_PWD='D:/aca2301390021/ripple4/ripple4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_add.tcl
